...
public class KeyValueInput implements Serializable {
   ...
   */
  public KeyValueInput(String name) {
    this.name = name;
  }

  public KeyValueInput description(@Nullable String description) {
  ...
  public KeyValueInput isRequired(Boolean isRequired) {
  ...
  public KeyValueInput format(FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public KeyValueInput value(@Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public KeyValueInput isSecret(Boolean isSecret) {
  ...
  public KeyValueInput _default(@Nullable String _default) {
  ...
  public KeyValueInput placeholder(@Nullable String placeholder) {
  ...
  public KeyValueInput choices(List<String> choices) {
    this.choices = choices;
    return this;
  }

  public KeyValueInput addChoicesItem(String choicesItem) {
  ...
  public KeyValueInput variables(Map<String, Input> variables) {
    this.variables = variables;
    return this;
  }

  public KeyValueInput putVariablesItem(String key, Input variablesItem) {
  ...
  public KeyValueInput name(String name) {
    this.name = name;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "name", example = "SOME_VARIABLE", description = "Name of the header or environment variable.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("name")
  ...
  public boolean equals(Object o) {
    ...
    KeyValueInput keyValueInput = (KeyValueInput) o;
    return Objects.equals(this.description, keyValueInput.description) &&
        Objects.equals(this.isRequired, keyValueInput.isRequired) &&
        Objects.equals(this.format, keyValueInput.format) &&
        Objects.equals(this.value, keyValueInput.value) &&
        Objects.equals(this.isSecret, keyValueInput.isSecret) &&
        Objects.equals(this._default, keyValueInput._default) &&
        Objects.equals(this.placeholder, keyValueInput.placeholder) &&
        Objects.equals(this.choices, keyValueInput.choices) &&
        Objects.equals(this.variables, keyValueInput.variables) &&
        Objects.equals(this.name, keyValueInput.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, isRequired, format, value, isSecret, _default, placeholder, choices, variables, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeyValueInput {\n");
