...
public class InputWithVariables implements Serializable {
  ...
  public InputWithVariables description(@Nullable String description) {
  ...
  public InputWithVariables isRequired(Boolean isRequired) {
  ...
  public InputWithVariables format(FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public InputWithVariables value(@Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public InputWithVariables isSecret(Boolean isSecret) {
  ...
  public InputWithVariables _default(@Nullable String _default) {
  ...
  public InputWithVariables placeholder(@Nullable String placeholder) {
  ...
  public InputWithVariables choices(List<String> choices) {
    this.choices = choices;
    return this;
  }

  public InputWithVariables addChoicesItem(String choicesItem) {
  ...
  public InputWithVariables variables(Map<String, Input> variables) {
    this.variables = variables;
    return this;
  }

  public InputWithVariables putVariablesItem(String key, Input variablesItem) {
  ...
  public boolean equals(Object o) {
    ...
    InputWithVariables inputWithVariables = (InputWithVariables) o;
    return Objects.equals(this.description, inputWithVariables.description) &&
        Objects.equals(this.isRequired, inputWithVariables.isRequired) &&
        Objects.equals(this.format, inputWithVariables.format) &&
        Objects.equals(this.value, inputWithVariables.value) &&
        Objects.equals(this.isSecret, inputWithVariables.isSecret) &&
        Objects.equals(this._default, inputWithVariables._default) &&
        Objects.equals(this.placeholder, inputWithVariables.placeholder) &&
        Objects.equals(this.choices, inputWithVariables.choices) &&
        Objects.equals(this.variables, inputWithVariables.variables);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, isRequired, format, value, isSecret, _default, placeholder, choices, variables);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InputWithVariables {\n");
