...
import nl.makan1869.registry.mcp.model.Input;
import nl.makan1869.registry.mcp.model.NamedArgument;
import nl.makan1869.registry.mcp.model.PositionalArgument;
...
@Schema(name = "Argument", description = "Warning: Arguments construct command-line parameters that may contain user-provided input. This creates potential command injection risks if clients execute commands in a shell environment. For example, a malicious argument value like ';rm -rf ~/Development' could execute dangerous commands. Clients should prefer non-shell execution methods (e.g., posix_spawn) when possible to eliminate injection risks entirely. Where not possible, clients should obtain consent from users or agents to run the resolved command before execution.")
...
public class Argument implements Serializable {
   ...
   */
  public Argument(TypeEnum type, String name) {
    this.type = type;
    this.name = name;
  }

  public Argument description(@Nullable String description) {
  ...
  public Argument isRequired(Boolean isRequired) {
  ...
  public Argument format(FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public Argument value(@Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public Argument _default(@Nullable String _default) {
  ...
  public Argument placeholder(@Nullable String placeholder) {
  ...
  public Argument choices(List<String> choices) {
    this.choices = choices;
    return this;
  }

  public Argument addChoicesItem(String choicesItem) {
  ...
  public Argument variables(Map<String, Input> variables) {
    this.variables = variables;
    return this;
  }

  public Argument putVariablesItem(String key, Input variablesItem) {
  ...
  public Argument valueHint(@Nullable String valueHint) {
  ...
  public Argument isRepeated(Boolean isRepeated) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, argument.description) &&
        Objects.equals(this.isRequired, argument.isRequired) &&
        Objects.equals(this.format, argument.format) &&
        Objects.equals(this.value, argument.value) &&
        Objects.equals(this.isSecret, argument.isSecret) &&
        Objects.equals(this._default, argument._default) &&
        Objects.equals(this.placeholder, argument.placeholder) &&
        Objects.equals(this.choices, argument.choices) &&
        Objects.equals(this.variables, argument.variables) &&
        Objects.equals(this.type, argument.type) &&
        Objects.equals(this.valueHint, argument.valueHint) &&
        Objects.equals(this.isRepeated, argument.isRepeated) &&
        Objects.equals(this.name, argument.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, isRequired, format, value, isSecret, _default, placeholder, choices, variables, type, valueHint, isRepeated, name);
  }
